-- =============================================================================
-- V2 — DOCUMENTOS CLÍNICOS: Plantillas, Documentos y Versiones
-- =============================================================================

CREATE TYPE document_status_enum AS ENUM ('DRAFT', 'PENDING_REVIEW', 'REJECTED', 'FINALIZED');
...
(
    ...
    template_id        uuid,                          -- Nullable: documentos externos sin plantilla
...
CREATE INDEX idx_documents_external ON documents(is_external_source);
